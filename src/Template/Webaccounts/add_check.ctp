...
<input type="text" name="login_id" id="login_id" class="form-control form-control-lg" placeholder="10文字以内で入力してください" maxLength="10">
<div class="error text-danger"><?=$this->Form->error("login_id");?></div>
</div>
<div class="form-group">
<label for ="pass">パスワード</label>
<input type="password" name="pass" id="pass" class="form-control form-control-lg" placeholder="5～10文字以内で入力してください" maxLength="10">
<div class="error text-danger"><?=$this->Form->error("pass");?></div>
</div>
<div class="form-group">
<label for="pass2">パスワード再確認</label>
<input type="password" name="pass2" id="pass2" class="form-control form-control-lg" placeholder="上記のパスワードと同様の値を入力してください"  maxLength="10">
<div class="error text-danger"><?=$this->Form->error("pass2");?></div>
<?php
if($error) {
?>
<p class="text-danger">パスワードが異なります</p>
<?php
}
?>
</div>
